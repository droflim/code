...
const nicks = [
  'maria', 'diego', 'ana', 'juan', 'luisa', 'pedro', 'carla', 'jose', 'maria', 'ana', 'luisa', 'carla', 'rosa', 'lina', 'sandra', 'sofia', 'carmen', 'valeria', 'veronica', 'natalia', 'isabella', 'paola', 'camila', 'elena', 'claudia', 'silvia', 'andrea', 'juanita', 'ana-maria', 'jessica', 'valentina', 'ana-silvia', 'johana',  'paulina', 'regina', 'gabriela', 'mariana', 'lucrecia', 'laura', 'eliana', 'renata', 'juliana', 'miranda', 'adriana', 'monica', 'ximena', 'diana', 'constanza', 'rosalia', 'pilar', 'olga', 'margarita', 'tania', 'viviana', 'celeste', 'nadia', 'alba', 'yolanda', 'verona', 'belen', 'carolina', 'ines', 'julia', 'angela', 'vicky', 'ariana', 'betty', 'soledad', 'irma'
];
